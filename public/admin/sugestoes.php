...
// Obter sugeres pendentes e contagem
...
<style>
:root { --primary: <?= $user_colors['primary'] ?>; --dark:#2c3e50; --light:#f8f9fa; --border:#e0e0e0; }
*{box-sizing:border-box;margin:0;padding:0;font-family:Roboto,Arial,Helvetica,sans-serif}
.admin-container{display:flex;min-height:100vh}
.admin-sidebar{width:250px;background:var(--dark);color:#fff;padding:1.5rem 0;position:fixed;height:100vh;overflow:auto}
.sidebar-header{padding:0 1.5rem 1.5rem;border-bottom:1px solid rgba(255,255,255,0.08)}
.sidebar-header h2{font-size:1.25rem;display:flex;align-items:center;gap:.75rem}
.sidebar-menu{padding:1rem 0}
.sidebar-menu a{display:flex;align-items:center;padding:.75rem 1.5rem;color:rgba(255,255,255,0.85);text-decoration:none;gap:.75rem}
.sidebar-menu a:hover,.sidebar-menu a.active{background:rgba(255,255,255,0.06)}
.badge{background:red;color:white;border-radius:999px;padding:2px 8px;font-size:0.8rem;margin-left:8px}

/* content */
.admin-content{flex:1;margin-left:250px;width:calc(100% - 250px)}
.admin-header{background:white;padding:1rem 2rem;display:flex;justify-content:space-between;align-items:center;box-shadow:0 2px 8px rgba(0,0,0,0.06);position:sticky;top:0;z-index:90}
.user-area{display:flex;align-items:center;gap:1rem}
.user-icon{width:40px;height:40px;border-radius:50%;background:var(--primary);color:#fff;display:flex;align-items:center;justify-content:center}
.content-area{padding:2rem}

/* sugestoes */
.sugestao-item{border:1px solid var(--border);border-radius:8px;padding:1rem;margin-bottom:1rem;background:#fff}
.sugestao-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:.5rem}
.sugestao-campo{font-weight:600;color:var(--primary)}
.sugestao-form{margin-top:1rem;padding-top:1rem;border-top:1px solid var(--border)}
.sugestao-form textarea{width:100%;min-height:100px;padding:.5rem;border:1px solid var(--border);border-radius:6px;margin-bottom:.75rem}
.sugestao-form select{padding:.5rem;border:1px solid var(--border);border-radius:6px;margin-right:.5rem}
.btn{display:inline-flex;align-items:center;padding:.6rem .9rem;border-radius:6px;border:none;cursor:pointer}
...
/* responsive */
@media (max-width:768px){.admin-sidebar{transform:translateX(-100%);position:fixed}.admin-sidebar.active{transform:translateX(0)}.admin-content{margin-left:0;width:100%}}
</style>
</head>
<body>
